// In this exercise, we are going to search through objects and become more and more familiar with accessing data inside large
// objects and arrays of objects.
// ## The Solar System, part 1
// The following data structure, `solarSystem`, is a common data structure: an **array** of **objects**. You will see this particular 
//data structure more and more as you venture into JSON and servers. This one is an **array** of **objects** which also contains **arrays**.
...
const solarSystem = [
  ...
  // 5. Add a new key value pair to the the Earth object: the key should be 'diameter', and the value should be Earth's diameter in miles 
  //represented as a string.
              console.log("5.");
              solarSystem[2].diameter=("1,234 mi");
...
console.log("3.");
var moons = parseInt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites
console.log(moons)
...
console.log("6.");
var difference = (system.jupiter.velocity * system.jupiter.mass) - ( system.pluto.velocity * system.pluto.mass);
